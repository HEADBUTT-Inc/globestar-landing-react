            ...
            <div className="w-full flex flex-col gap-8 items-center px-30 pb-30">
                ...
                <div className="w-full flex flex-col px-20 gap-4">
                    <p className="text-label-light">
                        <span className="text-label font-bold">철도시스템</span>은 차량, 신호, 통신, 전력, 궤도 등 서브시스템과 역사, 터널, 교량 등 토목 건축분야 등으로 구성되어 있습니다. 서브시스템은 서로 복잡한 연관관계를 형성하고 있어 차량이 기능과 성능을 발휘하려면, 신호, 전력공급, 궤도 등 타 서브시스템의 설계 기획단계에서부터 차량과의 인터페이스를 반영하여야 발주사가 목표로 한 성능을 발휘할 수 있습니다.
                    </p>
                    <p className="text-label-light">
                        <span className="text-label font-bold">시스템 엔지니어링 관리</span>는 시스템 레벨에서 설정한 엔지니어링 목표를 서브시스템으로 할당하여, 개별 서브시스템의 설계, 설계변경, 업그레이드와 피드백을 통하여 서브시스템의 성능이 시스템레벨에서 통합된 성능을 발휘하도록 기술, 시간, 인적자원을 관리합니다.
                    </p>
                    <p className="text-label-light">
                        <span className="text-label font-bold">철도시스템 건설과 운영</span>을 30년 이상 경험한 전문 기술인력을 활용하여 철도시스템 발주사가 설정한 목표를 프로젝트 진행단계에서 수행해야 하는 업무를 정의하여 문서화하고, 시스템 엔지니어링 개별분야 엔지니어들이 유기적으로 협력하여 시스템 엔지니어링 전체분야의 진행사항과 중요사항을 공유하며 개별 서브시스템을 전체로 통합했을 때 관련 서브시스템끼리 물리적, 성능적으로 적합하도록 발주사를 지원하고 공급사를 관리합니다.
                    </p>
                </div>
                <div className="w-full flex flex-col px-20 gap-4">
                    ...
                    <div className="flex justify-between">
                        <div className="w-[55%] flex flex-col text-label-light">
                            <div className="flex">
                        ...
                        <div className="w-[45%] flex items-center justify-center">
                            <img src={seExample} className="w-full object-contain" />
                        </div>
                    </div>
                </div>
            </div>
