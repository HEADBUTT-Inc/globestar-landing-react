        ...
        <div className="w-full flex flex-col gap-4">
            ...
            <div className="w-full flex flex-col gap-8 items-center px-30 pb-30">
                <div className="w-full h-60 relative">
                    ...
                    <div className="w-full h-full absolute flex flex-col top-0 left-0">
                        <p className="w-full h-4/5 px-24 bg-black/70 text-white flex items-center">
                            ISA(Independent Safety Assessment)는 독립안전평가로 유럽철도표준에 따라 철도시스템, 서브시스템 및 부품에 대한 안전성평가인증(SIL인증)입니다.
                        </p>
                ...
                <div className="flex h-60 w-full justify-center px-10 gap-8">
                    <img src={sil4} className="w-[40%] h-full object-cover" />
                    <img src={sil3} className="w-[40%] h-full object-cover" />
                </div>
                <p className="text-label-light px-10">
