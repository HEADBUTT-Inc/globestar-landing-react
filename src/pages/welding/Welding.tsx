    ...
    return <div className="w-full min-h-[calc(100vh-136px)] px-8 py-4 flex flex-col gap-4">
        ...
        <div className="w-full flex flex-col gap-4 px-30 pb-30">
            <div className="w-full h-50 relative">
                ...
                <div className="w-full h-full absolute flex flex-col top-0 left-0 px-24 bg-black/70 items-center justify-center">
            ...
            <div className="w-full h-100 flex gap-8">
                <div className="flex-1 relative" onClick={() => navigate("iso3834")}>
                    <img src={iso3834} className="w-full h-full object-cover" />
                    <div className="w-full h-full absolute flex flex-col top-0 left-0 text-white text-center">
                        <p className="flex items-center justify-center h-1/5 bg-primary/70">
                            ISO3834
                        </p>
                        <p className="flex items-center justify-center h-4/5 bg-black/70">
                            용접품질보증인증
                        </p>
                    </div>
                </div>
                <div className="flex-1 relative" onClick={() => navigate("en15085")}>
                ...
                <div className="flex-1 relative" onClick={() => navigate("en1090")}>
                ...
                <div className="flex-1 relative" onClick={() => navigate("wps")}>
